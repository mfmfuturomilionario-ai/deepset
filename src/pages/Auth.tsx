      ...
      >
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <h1 className="text-2xl font-bold font-display text-gradient">DEEPSET</h1>
          </div>
          <p className="text-muted-foreground text-sm">Resete seus bloqueios. Instale alta performance.</p>
        </div>
